...
Lire [docs/release-policy.md](/docs/forge/release/release-policy/) avant toute migration.
...
Avant de migrer, vérifier les dépréciations actives dans `CHANGELOG.md` et [docs/deprecation-policy.md](/docs/forge/release/deprecation-policy/).
...
Consulter la [matrice de compatibilité](/docs/forge/release/compatibility/) pour les versions officielles.
...
- [Politique de release](/docs/forge/release/release-policy/) — règles PATCH/MINOR/MAJOR
- [Politique de dépréciation](/docs/forge/release/deprecation-policy/) — cycle annonce → retrait
- [Matrice de compatibilité](/docs/forge/release/compatibility/) — versions supportées
- [Sécurité en production](/docs/forge/deployment/production-security/) — checklist avant déploiement
