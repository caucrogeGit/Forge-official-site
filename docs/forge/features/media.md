...
!!! info "Statut : opt-in officiel, publié sur PyPI depuis `1.0.0-beta.13`, API encore bêta"
    ...
    applicative reste bêta, voir [Limites](/docs/forge/deployment/production-limits/)
...
La dépendance `forge-mvc==1.0.0b13` doit être satisfaite. Si vous travaillez depuis
...
Ces garanties couvrent le code source audité en `1.0.0b13`. Elles ne couvrent pas la
