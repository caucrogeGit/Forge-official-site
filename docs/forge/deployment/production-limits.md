...
[Déploiement WSGI minimal](/docs/forge/deployment/wsgi-deployment/) (Gunicorn + Caddy/Nginx).
...
[ADR-002](/docs/forge/adr/002-session-strategy/).
...
mémoire — voir
[Déploiement WSGI § warnings](/docs/forge/deployment/wsgi-deployment/#6-warnings-production-au-demarrage).
...
Détail et exemples : [Déploiement WSGI § APP_TRUSTED_PROXIES](/docs/forge/deployment/wsgi-deployment/#5-app_trusted_proxies-et-x-real-ip).
...
- [Déploiement WSGI minimal](/docs/forge/deployment/wsgi-deployment/) — Gunicorn + reverse proxy
- [Guide de déploiement](/docs/forge/deployment/deployment/) — Architecture Nginx/systemd
- [Sécurité en production](/docs/forge/deployment/production-security/) — Cookies, headers, CSRF, uploads
- [ADR-002 — Stratégie de session](/docs/forge/adr/002-session-strategy/)
- [ADR-009 — Politique de stabilité terrain](/docs/forge/adr/009-stability-policy-terrain/)
