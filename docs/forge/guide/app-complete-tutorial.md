...
!!! warning "Tutoriel en cours de mise à jour"
    ...
    - Référence : [Le JSON canonique dans Forge](/docs/forge/entities/json-canonique/).
...
!!! tip "Nouveau sur Forge ?"
    Commencez par [Bonjour Forge](/docs/forge/guide/bonjour-forge/) pour découvrir les
...
Le [Contrat de stabilité](/docs/forge/release/stability-contract/) garantit formellement cette règle.
...
|---|---|
| Auth / connexion utilisateur | [Auth/User](/docs/forge/features/auth/) |
| Rôles et permissions (RBAC) | [Sécurité et RBAC](/docs/forge/philosophy/security/), [RBAC](/docs/forge/features/rbac/) |
| Relations `many_to_many` | [Relations entre entités](/docs/forge/features/relations/) |
| Envoi de mails | [Gestion des mails](/docs/forge/features/mail/) |
| Upload de fichiers / médias | [Module média](/docs/forge/features/media/) |
| Déploiement en production | [Déploiement](/docs/forge/deployment/deployment/) |
| Sécurité en production | [Sécurité en production](/docs/forge/deployment/production-security/) |
| API JSON légère | À venir — API-JSON-001 |
| Pages publiques | [Outils — Génération PDF, Module média](/docs/forge/features/media/) |
...
dans [Relations entre entités](/docs/forge/features/relations/).
...
| Étape | Ressource |
|---|---|
| Référence complète des commandes | [API et CLI](/docs/forge/reference/reference/) |
| Filtres de liste CRUD (`list.filter`) | [API et CLI — Filtres CRUD](/docs/forge/reference/reference/) |
| Comprendre les entités et modèles | [Architecture des entités](/docs/forge/features/entity_architecture/) |
| Déclarer des relations avancées | [Relations entre entités](/docs/forge/features/relations/) |
| Ajouter l'authentification | [Auth/User](/docs/forge/features/auth/) |
| Déployer en production | [Guide de déploiement](/docs/forge/deployment/deployment/) |
| Sécurité en production | [Sécurité en production](/docs/forge/deployment/production-security/) |
| Utiliser un starter complet | [Vue d'ensemble des starters](/docs/forge/starters/) |
| Passer à une version suivante | [Guide de migration](/docs/forge/features/migration-guide/) |
| Garanties sur les fichiers préservés | [Contrat de stabilité](/docs/forge/release/stability-contract/) |
...
- [Bonjour Forge](/docs/forge/guide/bonjour-forge/) — premier contact, sans BDD
- [Guide de démarrage](/docs/forge/guide/guide/) — parcours complet avec MariaDB
- [Relations entre entités](/docs/forge/features/relations/) — format `relations.json` complet
- [Architecture des entités](/docs/forge/features/entity_architecture/) — rôle de chaque fichier généré
- [Contrat de stabilité](/docs/forge/release/stability-contract/) — garanties sur les fichiers préservés
- [Référence API et CLI](/docs/forge/reference/reference/) — toutes les commandes
