...
!!! info "Où vivent les starters ?"
    ...
    un [module Forge](/docs/forge/philosophy/module-author-guide/).
...
peut être désinstallé proprement. Voir [Créer un module](/docs/forge/philosophy/module-author-guide/).
...
```json
{
  ...
  "description": "Application produits et catégories",
  "status": "available",
  "requires_db": true,
...
conformément à l'[ADR-003](/docs/forge/adr/003-language-convention/).
...
- [API et CLI](/docs/forge/reference/reference/) — liste complète des commandes `forge starter:*`
- [Créer un module](/docs/forge/philosophy/module-author-guide/) — brique réutilisable installable dans un projet existant
- [Vue d'ensemble des starters](/docs/forge/starters/) — starters officiels Forge
- [Application complète](/docs/forge/guide/app-complete-tutorial/) — exemple de build manuel
- [Relations entre entités](/docs/forge/features/relations/) — format `relations.json`
