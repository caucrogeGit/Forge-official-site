...
- [Référence API et CLI](/docs/forge/reference/reference/) — toutes les commandes disponibles
- [Guide de migration](/docs/forge/features/migration-guide/) — compatibilité entre versions
- [Politique de release](/docs/forge/release/release-policy/) — SemVer adapté à Forge
- [Politique de dépréciation](/docs/forge/release/deprecation-policy/) — cycle d'annonce et de retrait
...
- **Ne pas créer de tag manuellement** — les tags de version sont créés en suivant la [Procédure de release](/docs/forge/release/release/).
...
documentés dans la [Matrice de compatibilité](/docs/forge/release/compatibility/).
...
observable doit être reflété dans [Référence API et CLI](/docs/forge/reference/reference/).

### Quand modifier un guide spécifique

Si la fonctionnalité est couverte par un guide existant, mettez-le à jour :

- [Architecture des entités](/docs/forge/features/entity_architecture/) — nouveaux champs ou générateurs
- [Relations entre entités](/docs/forge/features/relations/) — nouvelle syntaxe relationnelle
- [Auth/User](/docs/forge/features/auth/) — nouvelles briques d'authentification
- [Sécurité et RBAC](/docs/forge/philosophy/security/) — nouveaux mécanismes de sécurité
- [Module média](/docs/forge/features/media/) — nouveaux comportements uploads
...
par Forge), ajoutez-le dans [Contrat de stabilité](/docs/forge/release/stability-contract/).
...
La feuille de route active est dans [Roadmap active](/docs/forge/roadmap/forge-roadmap/).
...
- **Publier une release** sans suivre la [Procédure de release](/docs/forge/release/release/)
...
- [Dépôt canonique et récupération de commits](/docs/forge/contributing/canonical-repo/) — checklist pré-ticket et procédure officielle de portage par patchs si des commits ont été créés hors du dépôt canonique
- [Conventions internes de Forge](/docs/forge/contributing/conventions/) — patterns opérationnels (audit, tests, code, doc)
- [Politique de release](/docs/forge/release/release-policy/) — SemVer adapté, règles de publication
- [Politique de dépréciation](/docs/forge/release/deprecation-policy/) — cycle d'annonce et de retrait
- [Matrice de compatibilité](/docs/forge/release/compatibility/) — Python, MariaDB, dépendances
- [Guide de migration](/docs/forge/features/migration-guide/) — comment migrer entre versions
- [Contrat de stabilité](/docs/forge/release/stability-contract/) — fichiers garantis préservés
- [Procédure de release](/docs/forge/release/release/) — étapes de publication d'une version
- [Validation locale](/docs/forge/release/release-local/) — checklist de validation avant release
- [Référence API et CLI](/docs/forge/reference/reference/) — toutes les commandes Forge
