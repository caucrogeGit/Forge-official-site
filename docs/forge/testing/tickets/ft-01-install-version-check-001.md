...
Forge utilise un format de version PEP 440 en interne (ex : `1.0.0b8`) et une notation SemVer dans certaines communications (ex : `1.0.0-beta.3`). Ces deux formats désignent la même version.
