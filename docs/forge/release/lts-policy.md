...
**Mitigation :** le [Contrat de stabilité](/docs/forge/release/stability-contract/) offre déjà
...
- [Politique de release](/docs/forge/release/release-policy/) — règles MAJOR/MINOR/PATCH
- [Politique de dépréciation](/docs/forge/release/deprecation-policy/) — cycle annonce → retrait
- [Contrat de stabilité](/docs/forge/release/stability-contract/) — garanties Forge 2.x
- [Matrice de compatibilité](/docs/forge/release/compatibility/) — Python, MariaDB, Node.js
