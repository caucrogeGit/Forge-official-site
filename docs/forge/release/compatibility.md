...
!!! info "Les onze opt-ins officiels sont publiés sur PyPI"
    ...
    `forge-mvc-images` reste au statut Bêta (API encore bêta).
...
- [Guide de migration](/docs/forge/features/migration-guide/) — vérifier la compatibilité avant de migrer
- [Politique de release](/docs/forge/release/release-policy/) — règles MAJOR/MINOR/PATCH
- [Sécurité en production](/docs/forge/deployment/production-security/) — checklist de déploiement
