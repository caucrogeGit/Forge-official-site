...
- [Politique de release](/docs/forge/release/release-policy/) — quand incrémenter MAJOR/MINOR/PATCH
...
[Contrat de stabilité](/docs/forge/release/stability-contract/)) peuvent changer sans
...
- [Guide de migration](/docs/forge/features/migration-guide/) — gérer les dépréciations lors d'une migration
- [Contrat de stabilité](/docs/forge/release/stability-contract/) — ce qui peut et ne peut pas changer
